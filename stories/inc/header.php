...
<head>
    ...
    <title>Web Truyên Tranh HV</title>
        ...
        <header class="row">
            ...
            <div class=" user-info_header col-md-3 col-sm-12 col-12">
                ...
                <div class="logout-user" style="margin-left: -12px;">
                    ...
                    <button class="btn btn-danger" onclick="location.href='DetailStory.php?dangxuat=1'" style=" font-size: 14px; height: 38px;"><i class="fa-sharp fa-solid fa-arrow-right-from-bracket"></i> Đăng xuất</button>
                </div>
            </div>
        </header>
